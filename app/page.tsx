        ...
        <div className="flex-1 flex flex-col justify-between px-4 sm:px-6 lg:px-8 pb-6 sm:pb-8">
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="max-w-5xl mx-auto text-center w-full">
              <h2
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 md:mb-8 leading-[1.3] pb-2"
                style={{
                  background:
              ...
              <p className="text-base sm:text-lg md:text-xl text-slate-400 max-w-4xl mx-auto mb-8 sm:mb-10 md:mb-12 leading-relaxed px-4">
              ...
              {!isSubmitted ? (
                ...
                <div className="max-w-md mx-auto bg-emerald-900/20 border border-emerald-700/50 p-4 sm:p-6 rounded-lg backdrop-blur-sm mb-6 sm:mb-8 mx-4">
